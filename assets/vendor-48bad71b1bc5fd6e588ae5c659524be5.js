...
return 2===arguments.length?(r=arguments[0],o=arguments[1],t=null):(t=(e=m.apply(void 0,arguments))[0],r=e[1],void 0===(i=e[2])?o=0:a(o=i.pop())||(n=!0===o,o=i.pop())),[t,r,i,o=parseInt(o,10),n]}var v=0,g=0,b=0,_=0,E=0,R=0,w=0,A=0,C=0,x=0,T=0,S=0,O=0,k=0,P=0,M=0,D=0,N=0,j=0,I=0,F=0,L=function(){function e(e,t){var r=this
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:g,end:b,events:{begin:_,end:0},autoruns:{created:N,completed:j},run:E,join:R,defer:w,schedule:A,scheduleIterable:C,deferOnce:x,scheduleOnce:T,setTimeout:S,later:O,throttle:k,debounce:P,cancelTimers:M,cancel:D,loops:{total:I,nested:F}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
